...
public class GeometryDSLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LINE", "CIRCLE", "TRIANGLE", "RECTANGLE", "FROM", "TO", "CENTER", "RADIUS", 
			"FUNCTION", "FOR", "WHILE", "IF", "ELSE", "PLUS", "MINUS", "MULTIPLY", 
			"DIVIDE", "GREATER", "LESS", "EQUAL", "NOT_EQUAL", "GREATER_EQ", "LESS_EQ", 
			"ID", "NUMBER", "WS"
		};
	}
